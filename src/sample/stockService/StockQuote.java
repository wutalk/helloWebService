    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(sample.stockService.StockQuote.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = sample.stockService.StockQuote.class.getResource(".");
